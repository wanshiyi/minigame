...
let GL = require ('./lightgl.js')
let Water = require('./water.js')
let Renderer = require('./renderer.js')
let Cubemap = require('./cubemap.js')
...
window.onload = function() {
  ...
  var imgxneg = new Image(); imgxneg.src = 'images/xneg.jpg';
  var imgxpos = new Image(); imgxpos.src = 'images/xpos.jpg';
  var imgypos = new Image(); imgypos.src = 'images/ypos.jpg';
  var imgzneg = new Image(); imgzneg.src = 'images/zneg.jpg';
  var imgzpos = new Image(); imgzpos.src = 'images/zpos.jpg';
  ...
  function draw() {
    ...
    renderer.renderWater(gl,water, cubemap,GL);
    renderer.renderSphere(gl,water);

...
function Renderer(gl,GL) {
  ...
  this.tileTexture = new GL.Texture();
  var temp = this;
  image.onload = (function () {
      temp.tileTexture = GL.Texture.fromImage(image, {
...
Renderer.prototype.updateCaustics = function (gl,water) {
  ...
  var this_ = this;
  this.causticTex.drawTo(function(gl) {
...
Renderer.prototype.renderWater = function (gl,water, sky,GL) {
...
Renderer.prototype.renderSphere = function (gl,water) {
  water.textureA.bind(0);
